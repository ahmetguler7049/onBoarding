...
class Survey(models.Model):
    ...
    date_created = models.DateField(auto_now_add=True, verbose_name="Oluşturma Tarihi", blank=False, null=False)
    text_q_count = models.IntegerField(verbose_name="Text Soru Sayısı", blank=True, null=True)
    test_q_count = models.IntegerField(verbose_name="Test Soru Sayısı", blank=True, null=True)
    selection_q_count = models.IntegerField(verbose_name="Dropdown Soru Sayısı", blank=True, null=True)
